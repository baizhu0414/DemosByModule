    ...
    public static void addStepsByRootMode(ContentValues values) {
        if (getExecCommandResult(
                ...
                String.format(
                        ...
                        values.getAsLong(ROMConstant.BEGIN_TIME),
                        values.getAsLong(ROMConstant.END_TIME),
                        values.getAsInteger(ROMConstant.MODE),
                        values.getAsInteger(ROMConstant.STEPS)
                ),
                ".quit",
                "exit") != ROMConstant.INTEGER_NULL) {
